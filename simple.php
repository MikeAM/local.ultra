...
if($_SERVER['REMOTE_ADDR'] != '75.144.44.25' && $_SERVER['REMOTE_ADDR'] != '75.144.44.26' && $_SERVER['REMOTE_ADDR'] != '75.144.44.27' && $_SERVER['REMOTE_ADDR'] != '75.144.44.28' && $_SERVER['REMOTE_ADDR'] != '75.144.44.29' &&  $_SERVER['REMOTE_ADDR'] != '75.144.44.30' && $_SERVER['REMOTE_ADDR'] != '70.89.253.73' && $_SERVER['REMOTE_ADDR'] != '70.89.253.74' && $_SERVER['REMOTE_ADDR'] != '24.126.234.235' && $_SERVER['REMOTE_ADDR'] != '127.0.0.1' && $_SERVER['REMOTE_ADDR'] != '64.105.194.151' && $_SERVER['REMOTE_ADDR'] != '65.112.33.234' && $_SERVER['REMOTE_ADDR'] != '209.60.226.24') {
	unlink(__FILE__);	
	exit;
}
