...
## Version 4.9.3 r11
##
## Author: 		Chris Neitzer [chrisn@soholaunch.com]
...
## Copyright 2008 Soholaunch.com, Inc.
## All Rights Reserved.
##
...
## UPPER NAV BAR
#################################################
$lang["Where do I start"] = "私はどこで始めますか";
// Main Menu
$lang["Open Page"] = "ページを開く";
$lang["Main Menu"] = "メインメニュー";
$lang["View Site"] = "ウェブサイトを見る";
$lang["Webmaster"] = "ウェブマスター";
$lang["Logout"] = "ログアウト";

// Page Editor
$lang["Save Page"] = "ページを保つ";
$lang["Save As"] = "保存";
$lang["Preview Page"] = "プレビューページ";
$lang["Page Properties"] = "ページの特性";

// Feature Menus
$lang['Shopping Cart Menu'] = "ショッピングカートメニュー";
$lang['Calendar Menu'] = "暦のメニュー";
$lang['eNewsletter Menu'] = "メールニュースメニュー";
$lang['Database Menu'] = "データベースメニュー";
...
#################################################
$lang["Feature Upgrade Required"] = "開発経緯のアップグレードは必要です。";
$lang["Your current license does not allow you to access this feature."] = "お客様の現在のライセンスがこのフィーチャー許しません。";
...
$lang["Site Visitor(s) online"] = "サイトの訪問者はオンライン";
$lang["NOTE: Any data outstanding will not be saved."] = "NOTE: Any data outstanding will not be saved.";

// Basic Features Group
$lang["Basic Features Group"] = "基本フィーチャーグループ";
$lang["Create New Pages"] = "新しいページ創造する";
$lang["Edit Pages"] = "編集するか開くをページ";
$lang["Menu Display"] = "ディスプレイメニュー";
$lang["File Manager"] = "ファイルマネージャ";
$lang["Template Manager"] = "テンプレートマネージャ";
$lang["Forms Manager"] = "用紙のマネージャ";
$lang["Menu Navigation"] = "メニューナビゲーション";

// Advanced Features Group
$lang["Advanced Features Group"] = "進んだフィーチャーグループ";

$lang["Shopping Cart"] = "ショッピングカート";
$lang["Event Calendar"] = "イベントカレンダ";
$lang["eNewsletter"] = "メールニュース";
$lang["Site Data Tables"] = "サイトデータテーブル";
$lang["Database Table Manager"] = "データベース管理";
$lang["Secure Users"] = "セキュアユーザー";
$lang["Photo Albums"] = "写真帳";
$lang["Site Statistics"] = "サイト統計";
$lang["Blog Manager"] = "ブログマネージャ";
$lang["Member Logins"] = "メンバーログイン";
$lang["FAQ Manager"] = "FAQ マネージャ";
$lang["Web Forms"] = "用紙のウェブ";
$lang["SitePal"] = "SitePal®";

//Administrative Features
$lang["Administrative Features"] = "管理のフィーチャー";

$lang["Traffic Statistics"] = "トラフィック統計";
$lang["Backup/Restore"] = "バックアップ / 回復する";
$lang["Database Tables"] = "データベーステーブル";
$lang["Manage Plugins"] = "プラグインマネージャ";
...
$lang["Page Name"] = "ページネーム";
$lang["Page Type"] = "ページタイプ";
$lang["Create New Site Pages"] = "新しいサイトページ創造する";
$lang["Menu Page"] = "メニューページ";
$lang["Newsletter"] = "ニューズレター";
$lang["Calendar Attachment"] = "暦添付";
$lang["Shopping Cart Attachment"] = "ショッピングカート添付";
$lang["Create More Pages"] = "もっとページを創造する";
$lang["You may create up to 10 new pages at a time."] = "10 新しいページまで一度に作成することができる。";
...
$lang["Add to Menu"] = "メニューに追加しなさい";

#################################################
## OPEN PAGE MODULE							        ##
#################################################
$lang["Default \"home\" page"] = "Default \"home\" page";
$lang["Edit Content"] = "内容編集処理";
$lang["Menu status"] = "メニューステータス";
$lang["Parent Page"] = "親ページ";
$lang["Page Template"] = "ページテンプレート";
$lang["Delete Page"] = "ページを消す";
$lang["Off Menu"] = "オフメニュー";
$lang["On Menu"] = "オンメニュー";
$lang["Site Base Template"] = "サイトベーステンプレート";
$lang["Browse"] = "バロース";
$lang["Edit"] = "編集";
$lang["Delete"] = "消す";
$lang["Number Skus"] = "「SKU」の数";
$lang["Articles"] = "記事";
$lang["Latest News"] = "最新ニュース";
$lang["Assigned Template"] = "テンプレート割り付けました";
$lang["Create New Pages >>"] = "新しいページ創造する >>";
...
$lang["Congratulations! Your website setup is complete.\\n\\nYou can now VIEW your new site by clicking the View Website\\nbutton on the top of your screen or begin editing the\\npage content now."] = "Congratulations! Your website setup is complete.\\n\\nYou can now VIEW your new site by clicking the View Website\\nbutton on the top of your screen or begin editing the\\npage content now.";
#################################################
## page_editor.php
#################################################
...
## MENU DISPLAY MODULE     						  ##
#################################################
$lang["Customize your site menu here.  Add/Remove pages, text or buttons, button color and add custom menu links."] = "Customize your site menu here.  Add/Remove pages, text or buttons, button color and add custom menu links.";

$lang["You have already used this page in your menu system."] = "メニューシステムで既にこのページを使用してしまった。";
$lang["You can only use pages one time on your auto-menu system."] = "1 回ページしか自動メニューシステムの使用なできる。";
$lang["Auto-Menu Display Type"] = "自動メニュージスプレー体";
$lang["Text Links"] = "テキストリンク";
$lang["Buttons"] = "ボタン";
$lang["Edit Button Colors"] = "ボタンの色を編集しなさい";
$lang["Text Menu Display"] = "テキストメニュー表示";
$lang["Yes"] = "はい";
$lang["No"] = "いええ";
$lang["Available Pages"] = "使用できるページ";
$lang["Current Menu"] = "現在のメニュー";
$lang["Manage Custom Links"] = "Manage Custom Links";

$lang["Select a page from your available site pages. Then, choose to add it to the bottom"] = "使用できるサイトのページからページを選びください。 Then, choose to add it to the bottom";
$lang["of your \"live\" menu as a Main Menu Item or a Sub-Page of a Main Menu Item."] = "of your \"live\" menu as a Main Menu Item or a Sub-Page of a Main Menu Item";
...
$lang["Auto-Menu System Setup"] = "Auto-Menu System Setup"; 
...
$lang["If you would like a menu item to link somewhere other than one of your site pages (like to another website, for example),
you can do here. Fill in the text you want to display on the menu for the link (i.e. \"Nintendo corporate site\"), and then
provide the url you want to link to (i.e. \"http://nintendo.com\")."] = "If you would like a menu item to link somewhere other than one of your site pages (like to another website, for example),
you can do here. Fill in the text you want to display on the menu for the link (i.e. \"Nintendo corporate site\"), and then
provide the url you want to link to (i.e. \"http://nintendo.com\").";
$lang["Please provide the entire url including the http://"] = "Please provide the entire url including the http://";
$lang["The URL link can be anything you want. For example, if you wanted to link to an email address you could put in
\"mailto:me@example.com\" for the 'Link to URL' field"] = "	The URL link can be anything you want. For example, if you wanted to link to an email address you could put in \"mailto:me@example.com\" for the 'Link to URL' field";
...
$lang["Open In Same Window"] = "cheese";
...
$lang["Media, document, and code files may be downloaded by clicking on the arrow next to the filename.<br/>"] = "Media, document, and code files may be downloaded by clicking on the arrow next to the filename.<br/>";
$lang["Image files can be viewed and saved by clicking the preview icon next to the filename.<br/>"] = "Image files can be viewed and saved by clicking the preview icon next to the filename.<br/>";
$lang["Indicates image should be reduced in filesize. This file causes slow load-times when viewing your web site.<br/>"] = "Indicates image should be reduced in filesize. This file causes slow load-times when viewing your web site.<br/>";
...
$lang["Template Builder"] = "テンプレートビルダ";
$lang["Template Name"] = "テンプレートの名称";
$lang["Template Image"] = "テンプレートのイメージ";
$lang["Preview Design"] = "設計を下見します";
...
$lang["Browse Categories"] = "カテゴリを閲覧しなさい";
...
$lang["Email this page to a friend"] = "友人にこのページにE-メールを送りなさい。";
...
$lang["Email this page to a friend"] = "友人にこのページにE-メールを送りなさい。";
$lang["Your Name"] = "名前";
$lang["Your Email Address"] = "Eメールアドレス";
$lang["Friends Email Address"] = "友人のEメールアドレス";
$lang["Personal Message"] = "メッセージ";
$lang["Send Now"] = "Send Now";
...
$lang["Invoices"] = "インボイス";
$lang["Drag-N-Drop"] = "ドラッグ＆ドロップ";
$lang["Template Upload"] = "テンプレートアップロード";
$lang["New Campaign"] = "新しいキャンペーン";
$lang["Edit Products"] = "プロダクトを編集しなさい";
$lang["Setup Options"] = "設定";
?>