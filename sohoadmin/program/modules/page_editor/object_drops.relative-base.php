...
function objTemplate(objName, txtHead, objHeight){
   ...
   obj_items[0] = RandNum
	...
	if(txtHead)
	   TextHeader = "<img src=\"sohoadmin/program/modules/page_editor/images/text_header.gif\" width=\"199\" height=\"15\" border=\"0\" align=\"center\" vspace=\"0\" hspace=\"0\" style='cursor: move;'><BR CLEAR=ALL>";
...
function OkWordData() {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<div ID="+docID+"><img src='sohoadmin/program/modules/page_editor/client/download_icon.gif' align=absmiddle vspace=0 hspace=2 border=0 width=20 height=19> <font face=Arial style='font-size: 8pt;'><U>"+tWordFile+"</U></font></div><!-- ##MSWORD;"+tWordFile+"## -->");
...
function pageCounter() {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<img src='sohoadmin/program/modules/page_editor/client/counter_tool.gif' width=90 height=20 border=0 alt=\"Hit Counter\"><!-- ##COUNTER## -->");
   document.getElementById(ColRowID).innerHTML= finalObj;
...
function OkCartSku() {
   ...
   if(arguments.length > 0){
      ...
      finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<img src='sohoadmin/program/modules/page_editor/client/cartsearch_tool.gif' width=199 height=71 border=0 class=tHead vspace=0 hspace=0><!-- ##CARTSEARCH## -->");
...
function OkMP3Data() {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<div ID="+audioID+"><font style='font-family: Arial; font-size: 8pt;'><img src='sohoadmin/program/modules/page_editor/client/download_icon.gif' align=absmiddle vspace=0 hspace=2 border=0 width=20 height=19><U><font color=blue>"+tMP3+"</font></u></font></div><!-- ##MP3;"+tMP3+"## -->");
...
function adobelink() {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<img src=sohoadmin/program/modules/page_editor/client/adobe_link.gif border=0 class=tHead><!-- ##ADOBELINK## -->");
...
function flashlink() {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<img src=sohoadmin/program/modules/page_editor/client/flash_link.gif border=0 class=tHead><!-- ##FLASHLINK## -->");
...
function winamplink() {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<img src=sohoadmin/program/modules/page_editor/client/winamp_link.gif border=0 class=tHead><!-- ##WINAMPLINK## -->");
...
function quicktimelink() {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<img src=sohoadmin/program/modules/page_editor/client/quicktime_link.gif border=0 class=tHead><!-- ##QUICKTIMELINK## -->");
...
function OkWordDataUP(tWordFile) {
   ...
   finalObj = tmplt[1].replace("##OBJ_DISPLAY##", "<div ID="+docID+"><img src='sohoadmin/program/modules/page_editor/client/download_icon.gif' align=absmiddle vspace=0 hspace=2 border=0 width=20 height=19> <font face=Arial style='font-size: 8pt;'><U>"+tWordFile+"</U><font color=#999999> [Size]</font></font></div><!-- ##MSWORD;"+tWordFile+"## -->");
...
function place_supersearch() {
   ...
   // MoveObject_Graphic = ;
	...
	TableStart += "   <img src=\"sohoadmin/program/modules/page_editor/images/text_header.gif\" width=199 height=15 border=0 align=left vspace=0 hspace=0 style=\"cursor: move;\"><br clear=\"all\">";
   TableStart += "  </td>\n";
   TableStart += " </tr>\n";
