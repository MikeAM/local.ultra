...
$file = fopen("$filename", "r");
	$TMP_HTML = fread($file,filesize($filename));
fclose($file);
	
if (!eregi("#ADDFIELD#", $TMP_HTML)) {
	echo "<SCRIPT LANGUAGE=Javascript> alert('This form can not be modified by the forms builder.\\n\\nDownload and modify this form from Site Files.');\n";
	echo "window.location = \"../forms.php?dropArea=$dropArea&selkey=Forms&=SID\"; </SCRIPT>\n";
	exit;
}
...
if (isset($COMPLETE_FORM)) {
	...
	// ============================================================================
	// PULL ORIGINAL FILE INTO MEMORY  
	// ============================================================================
	...
	$HTML_OUTPUT = eregi_replace("<!-- #ADDFIELD# -->", $HTML_OUTPUT, $BASE_HTML);
...
if ($FORM_NAME == "") {
	...
	$lookat = eregi_replace("$doc_root/media/", "", $lookat);
	$lookat = eregi_replace("\.form", "", $lookat);
...
<HTML>
<HEAD>
<TITLE>Form Field Addition V1.0</TITLE>
...
<FORM METHOD=POST ACTION="form_add.php">
  ...
  <TABLE BORDER="0" ALIGN="CENTER" CELLPADDING="10" CELLSPACING="0" CLASS="text" STYLE="background: white; BORDER: 1PX SOLID BLACK">
    <TR ALIGN="RIGHT"> 
      <TD COLSPAN="2" BGCOLOR="#000066"><B><FONT COLOR="#FFFFFF">Form Name: <INPUT TYPE="text" DISABLED NAME="FORM_NAME" VALUE="<?php echo $FORM_NAME; ?>" CLASS="text" STYLE='width: 150px;' MAXLENGTH=40>
        : Field <?php echo $COUNTER; ?></FONT></B>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="show_help();"><img src="../help.gif" hspace=2 vspace=2 border=0 align="absmiddle"></a></TD>
    </TR>
    <TR BGCOLOR="#EFEFEF"> 
    ...
    <TR ALIGN="RIGHT" VALIGN="MIDDLE" BGCOLOR="#EFEFEF"> 
      <TD COLSPAN="2"><INPUT NAME="NXT" TYPE="SUBMIT" CLASS="FormLt1" VALUE="Add Next Field &gt;&gt;"> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      </TD>
    </TR>
  </TABLE>
  ...
  ?>
    ...
    <BR>
    <INPUT TYPE="BUTTON" NAME="COMPLETE_FORM" CLASS="FormLt1" VALUE="Cancel Add Fields" onclick="cancel_build();">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <INPUT TYPE="SUBMIT" NAME="COMPLETE_FORM" CLASS="FormLt1" VALUE="Form Additions Complete">
  </DIV>
</FORM>
</DIV>
</BODY>
