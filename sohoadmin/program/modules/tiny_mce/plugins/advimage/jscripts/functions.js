...
function checkImgField(){
   ...
   showPreviewImage(elmSrc.value)
//   var elmPrev = document.getElementById('prev');
//   if(elmSrc.value != ''){
//      elmPrev.innerHTML = '<img id="previewImg" src="' + elmSrc.value + '" border="0" onload="updateImageData();" onerror="resetImageData();" />'
//   }
}
