...
$THIS_DISPLAY .= "<FORM name=\"returns\" METHOD=POST ACTION=returns_policy.php>\n";
...
$THIS_DISPLAY .= "<div class=\"center\"><button type=\"button\" class=\"greenButton\" onClick=\"document.returns.submit();\"><span><span>".lang("Save Returns/Exchanges Policy")."</span></span></button></div>\n\n";
