...
<!---     <tr>
    ...
    <tr>
     <td width="30%" valign="top"><? echo $top_x; ?> search queries</td>
     <td width="30%" valign="top">Queries that returned results</td>
     <td width="40%" valign="top">Queries that returned zero matches</td>
    </tr>
    <tr>
     <td valign="top">
...
while ( $getData = mysql_fetch_array($rez) ) {
   ...
   if ( $getData['found'] == "no" ) {
      echo "     <td>".$getData['search_phrase']."<span class=\"bold red\">*</span></td>\n";
   } else {
      echo "     <td>".$getData['search_phrase']."</td>\n";
   }
...
while ( $getData2 = mysql_fetch_array($rez) ) {
   ...
   if ( $getData2['found'] == "yes" ) {
      ...
      echo "    <tr class=\"".$bgcolor."\">\n";
      echo "     <td class=\"gray\">".$counter."</td>\n";
      echo "     <td>".$getData2['search_phrase']."</td>\n";
