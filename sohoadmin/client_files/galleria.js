...
//            var elems = 'overlay box galcontent shadow title info close prevholder prev nextholder next counter image',
            var elems = 'overlay box galcontent shadow title info close counter image',
                el = {},
                op = self._options,
                css = '',
                cssMap = {
                    ...
                    galcontent:    'position:absolute;background-color:#ffffff;top:10px;left:10px;right:10px;bottom:30px;overflow:hidden',
...
//                    close:      'position:absolute;top:10px;right:10px;height:20px;width:20px;background:#fff;text-align:center;cursor:pointer;color:#444;font:16px/22px arial,sans-serif;z-index:99999',
                    image:      'cursor:pointer;position:absolute;top:5px;left:5px;right:5px;bottom:5px;overflow:hidden'
...
//                    next:       'position:absolute;top:50%;margin-top:-20px;height:40px;width:30px;background:#fff;right:20px;left:auto;display:none;line-height:40px;text-align:center;color:#000',
            ...
            // append the elements
            self.append({
                //'lightbox-box': ['lightbox-shadow','lightbox-galcontent', 'lightbox-close','lightbox-prevholder','lightbox-nextholder'],
                'lightbox-box': ['lightbox-shadow','lightbox-galcontent'],
                //'lightbox-info': ['lightbox-title'],
                'lightbox-galcontent': ['lightbox-image']
		  ...
		  $( el.image ).bind( CLICK(), lightbox.hide );
...
Galleria.prototype = {
    ...
    */
    ...
    _init: function() {
        ...
        // load up target galcontent
        this.load();

        // now it's usually safe to remove the galcontent
