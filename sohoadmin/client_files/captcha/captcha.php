...
//	$key .= "</form>\n";
	...
	$key .= "<input name=\"capval\"  id=\"capval\" type=\"hidden\" value=\"".md5($synckey)."\">\n";
	$key .= "Please&nbsp;enter&nbsp;the&nbsp;phrase&nbsp;as&nbsp;it&nbsp;is&nbsp;shown&nbsp;in&nbsp;the&nbsp;box&nbsp;above.&nbsp;&nbsp;&nbsp;\n";
	//$key .= "<td align=\"left\">\n";
	$key .= "<input name=\"cap\"  id=\"cap\" type=\"text\" size=\"6\" maxlength=\"6\" style=\"border:1px solid black; text-align:left; font-size:18px;\"></td></tr>\n";
	$key .= "</table>";
